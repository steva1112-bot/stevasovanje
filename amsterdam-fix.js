...
(function(){
var s=document.createElement('style');
s.textContent='#egipat-pages .book-page-slide{display:none!important;}#egipat-pages .book-page-slide.active,#egipat-pages .book-page-slide.right-visible{display:block!important;}';
document.head.appendChild(s);
var P=["Egipat — vitamin D i pasoš","Putopis iz oktobra 2021.","I. Deficit","Korona je 2021. bila u punom zamahu, a ja sam bio u punom deficitu vitamina D.","Sećamo se svi onog perioda — zatvaranje, ne izlaženje, onaj čudni tihi tok života u kom je odlazak do prodavnice izgledao kao mali podvig. A onda je nebo otvorilo granice i svi su stidljivo počeli da putuju — kao što se izlazi iz zatvora posle duge kazne.","Te godine sam trebao da putujem u Tivat. Familija, rođaci, drugari. A onda sam propustio let u poslednjem trenutku.","Moje telo je reagovalo odmah — podmuklo, tiho. Počelo je da vapi. Vitamin D. More. Sunce. Bilo šta što nije Beograd u oktobru.","Egipat mi nikad nije bio visoko na listi. Ipak, kada turistička agencija čiji je vlasnik Egipćanin počne da te bombarduje povoljnim ponudama — deset noćenja, all inclusive, hotel četiri ili pet zvezdica — deficit vitamina D počne sam da donosi odluke umesto tebe.","Oktobar. Drugar. Paket aranžman. PCR test od sedamdeset evra.","A onda je univerzum ubacio jedan telefonski poziv u priču. Dalji rodak. Radi na Torlaku. Živi na Ceraku, pet minuta vožnje od mog stana.","Dogovor je bio jednostavan, a scena vredna kratke priče. Ujutro me sačekao na parkingu u pidžami — jednom rukom termos kafe, drugom vrećica sa laboratorijskom aparaturom. Mi pretvaramo kapak gepeka u improvizovani laboratorijski sto.","Test je bio negativan. Pečat je dobio svežijeg datuma. Nije baš po knjizi. Ali rodja se potrudio. I sunce me je čekalo.","Košava je produvala Beograd taj dan. Za par sati će sve to izaći iz mene, negde nad Mediteranom.","II. Sletanje — Hurghada","Let do Hurgade — tri sata. Sletanje — dva pokušaja. Drugi pokušaj uspešan. Aplauz koji je usledio bio je od srca — pravi aplauz čoveka koji je pre trideset sekundi preispitivao sve životne odluke.","Vazduh koji ti udari u lice čim se otvore vrata aviona — miriše na malo soli, malo peska i na toplinu jer drugog imena nema.","Sa jedne strane palme i zelena trava. A onda okrenete pogled i vidite nepreglednu pustinju, kuće bez prozora. Glamur i beda na razmaku od deset metara. Nigde na svetu nisam video taj kontrast tako oštar.","Ulazimo u velelepni hol sa ogromnom centralnom fontanom. Sobe još nisu spremne. Crvena narukvica oko ruke. All inclusive se otvara.","III. Teritorija — Strategija ležaljke","Pronašli smo mesto blizu šanka — strateška odluka posle prvog iskustva s toplim pivom. I tu smo ostali do kraja letovanja. Znalo se da su to naše ležaljke iako nigde nije pisalo.","Na šanku nas je čekao naš novi prijatelj. Za koji dolar bakšiša — velika čaša, hladno pivo i nasmejano lice. Jugoslavija na dvadesetak ležaljki u Egiptu, na Crvenom moru, u oktobru.","IV. Doktor sa šanka","Posle par dana stomak je odlučio da se oglasi. Možda bakterije, možda začini, možda voda. Naravno da sam pio probiotik. Naravno da nije pomoglo.","Prošao pored šanka. Naš prijatelj pogledao onim pogledom koji ne traži objašnjenje. Nisam znao da imam lekara na šanku.","Sipa mi u malu čašu neko providno piće. Cimnuo sam obe čaše — i kad sam ih otvorio, još jedna tura i uzvik: Van mor tajm. Stomak je u momentu prestao da me muči.","To piće zove se arak — anis. Biljka koja se vekovima koristi za stomak. Radi bolje od svakog probiotika. Od tog trenutka — bila je to terapija.","U nekom ćutanju začuo sam zapomaganje. Nikola. Zrenjaninac. Pozivam ga u ordinaciju na šanku i otkrivam čudotvorni lek. Medicina se deli.","V. Dno mora","Ronjenje za upola manje od hotelske cene. Dolazi nasumičan lik u Mitsubishi Lanceru 2005. godište. Obilazimo još jedan hotel, kupimo još jedan par iz Mladenovca.","Sat i po vožnje — filozofija. Tamo voze kao da su propisi više predlog nego obaveza. Svirne jednom za desno, dva puta za levo — kao Morzeova azbuka: skloni se.","Na brodu usmena obuka. Red na mene. A onda pritisak u ušima. Instruktor me vukao dublje. Istrgnuo sam se i izronio. Kakvo olakšanje.","I onda se desilo ono zbog čega se sve isplatilo. Ogroman morski greben kao dvorac — stvorenja svih boja i veličina. Tišina ispunjena bojama.","Primetio sam da zaposleni dižu boce sa kiseonikom kao da su od pera. Glava me je bolela. Nije bio delfin — bio je arapin koji je potrošio kiseonik iz moje boce. Glava me je bolela u pravo vreme.","VI. Sto za šestoro","Srećem Nikolu. Priključuje se još jedan par iz Novog Sada. Ta medicina se prenosi s kolena na koleno. Upoznao sam ljude s kojima sam ostao u kontaktu do danas.","Pojavio se Lala. Vojvođanin, razvlači reči. Bio je PCR pozitivan u karantinu. Za par desetina dolara dobio slobodu. Pronašao, ekspresno, ženu svog života.","VII. Kvadovi i pogrešna utakmica","Naleteo na odbojkašku utakmicu Srbija — Poljska. Pet setova, izgubili. Saznali da se taj meč odigrao mesecima unazad.","Vožnja kvadovima po pustinji. Svi prodavci su me zvali Serbian boss. Zalazak sunca — nebo u dvadesetak nijansi narandžaste, pesak uhvati isti ton — ceo svet izgleda kao da ga je neko slikao temperom.","VIII. Povratak","Na aerodromu nasumično birali putnike. Svi prošli — sem Ladislava koji je odležao dve nedelje kući. Poslednja žrtva.","Nije bila ono što sam očekivao. Bila je manje. I bila je više — zbog parking-laboratorijuma u pidžami, zbog anisa koji leči bez dijagnoze, zbog Lancera iz 2005, zbog prazne boce kiseonika.","Vitamin D na maksimumu. Novi drugari. Jedno novo bogatstvo.","— Hurghada / Beograd, oktobar 2021."];
function bpE(pp){var pages=[],c='';for(var i=0;i<pp.length;i++){var p=pp[i];if(c.length>0&&c.length+p.length+2>900){pages.push(c);c='';}c=c.length>0?c+'\n\n'+p:p;}if(c.length>0)pages.push(c);return pages;}
window.egipatSetup=function(){
  ...
  for(var i=0;i<pages.length;i++){var sl=document.createElement('div');sl.className='book-page-slide'+(i===0?' active':'');if(i===1)sl.classList.add('right-visible');pages[i].split('\n\n').forEach(function(t){var p=document.createElement('p');p.className='book-page-text';p.textContent=t;sl.appendChild(p);});cont.appendChild(sl);}
  var tot=cont.children.length,n=0,pairTot=Math.ceil(tot/2);
  var co=document.getElementById('egipat-counter'),pv=document.getElementById('egipat-prev'),nx=document.getElementById('egipat-next');
